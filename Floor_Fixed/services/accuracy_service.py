...
def performAccuracyAnalysis(model_results, image_width, image_height):
    ...
    analysis = {
        ...
        # object_analysis covers all 7 project classes
        "object_analysis": {
            ...
            "stairs":   {"count": 0, "avg_confidence": 0.0, "avg_size": 0.0},
            "parking":  {"count": 0, "avg_confidence": 0.0, "avg_size": 0.0},
            "balconies":{"count": 0, "avg_confidence": 0.0, "avg_size": 0.0},
            "terraces": {"count": 0, "avg_confidence": 0.0, "avg_size": 0.0},
        },
        "spatial_analysis": {
            "bbox_overlaps":   0,
            "size_anomalies":  [],
    ...
    # Keys 1-7 match all project class IDs; unknown detections are stored under key 0
    class_data = {0: [], 1: [], 2: [], 3: [], 4: [], 5: [], 6: [], 7: []}
    ...
    # Map all 7 class IDs to their human-readable keys in object_analysis
    class_names = {
        1: "walls",
        2: "windows",
        3: "doors",
